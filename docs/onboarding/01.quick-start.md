...
- **访问地址**：`https://kcloud.zitian.party`
...
- 平台服务（Vault、Dashboard、Atlantis）是共享的
...
打开 `https://kcloud.zitian.party`，使用 Casdoor 登录（GitHub 或密码）。

**期望结果**：看到 Kubero 欢迎页面，可以创建 Pipeline。

### 2. 访问 Vault UI（可选）

打开 `https://secrets.zitian.party`，使用 OIDC 登录。
...
### Q: 我可以使用自己的域名吗？
**A**: 可以，需要联系运维团队配置 Cloudflare DNS。参考 [platform.network.md](../ssot/platform.network.md)。
