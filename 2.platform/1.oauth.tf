# OAuth2 Proxy - Unified Authentication Gateway
# Namespace: platform
# URL: auth.{base_domain}
# Protects: All i-* services via forward-auth
#
# SETUP REQUIRED:
# 1. Create GitHub OAuth App: https://github.com/settings/developers
#    - Homepage URL: https://auth.{base_domain}
#    - Callback URL: https://auth.{base_domain}/oauth2/callback
...
output "oauth2_proxy_auth_url" {
  value       = "https://auth.${var.base_domain}/oauth2/auth"
