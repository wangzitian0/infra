...
|---|---|---|
| **L0 Orchestration** | [`.terrateam`](.terrateam/config.yml) | Terraform Automation, Plan/Apply Locking, CI/CD |
| **L0 Config** | [`terraform`](terraform/README.md) | Root Module, Global Vars, Envs (`*.tfvars`) |
