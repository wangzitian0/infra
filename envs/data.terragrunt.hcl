# =============================================================================
# Data Layer Configuration (Shared by All Environments)
...
# Layer Dependencies
# =============================================================================
# Data layer depends on Platform for infrastructure services
...
dependency "platform" {
  ...
  # Mock outputs for plan-time (before Platform is applied)
  mock_outputs = {
