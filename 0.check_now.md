...
Status: **Domain Naming Convention (i-/x-)**
Last Updated: 2025-12-08
Change Log: [2025-12-08.domain_naming.md](docs/change_log/2025-12-08.domain_naming.md)

## 1. Context: What are we doing?
Implementing standardized domain naming convention with i-/x- patterns.

## 2. Why?
Need clear domain naming for:
- Internal infrastructure services (admin-only)
- External user-facing services (CDN protected)
- Ephemeral test environments (PR/commit previews)
...
| `terraform/1.nodep/README.md` | Update DNS architecture docs |
