...
### 要求
1. **启用 Atlantis Web UI 认证** - 添加 Basic Auth 或 GitHub OAuth
2. **配置 Atlantis 隐藏敏感输出** - 或将 repo 改为 private

### 解决方案
在 `1.bootstrap/2.atlantis.tf` 添加：
```hcl
