...
**Status**: Active
**Focus**: Cloudflare Integration & Network Refactor

## 1. Context: What are we doing?
We are integrating Cloudflare for DNS management and certificate automation, and refactoring the network domain convention.
