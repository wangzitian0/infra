...
- L2 Platform: `removed.tf` / `moved.tf` (namespace state migration)
...
- [x] **Platform State Migration**: Use Terraform `removed` block to avoid destroying `platform` namespace from stale L2 state
